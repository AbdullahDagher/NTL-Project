...
$token = sha1(uniqid());
$_SESSION['CSRF_token_forgetPassRegistration']= $token;
...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    if(isset($_POST['csrf_token']) && $_POST['csrf_token'] == $_SESSION['CSRF_token_forgetPass']){
...
}elseif(isset($_SESSION['resetUser']) && !empty($_SESSION['resetUser'])){
//    echo $_SESSION['resetUser'];
}else{
    header('Location: forget-password.php');
    exit();
}
            ...
            <div class="m-login__container">
                <div class="m-login__signin">
                    <div class="m-login__head">
                        ...
                        <div class="m-login__desc">Please choose your security question and submit your answer </div>
                    </div>
                    <form class="m-login__form m-form" action="forget-password-registration-submission.php" method="post">
                        ...
                        <input type="hidden" name="csrf_token" value="<?php echo $_SESSION['CSRF_token_forgetPassRegistration']; ?>" />

                        <div class="form-group">
                            <select class="form-control m-input m-input--pill" id="exampleSelect1" name="QID">
